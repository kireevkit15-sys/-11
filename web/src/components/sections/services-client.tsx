...
// Client Component
// ---------------------------------------------------------------------------
export function ServicesSectionClient({ normalServices, fsiService }: ServicesSectionClientProps) {
      ...
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-12">
            {normalServices.map((s, i) => (
              <NormalCard
                ...
                index={i}
                reduced={reduced}
                expanded={expandedCards.has(s.title)}
                onToggleExpand={() => toggleExpanded(s.title)}
