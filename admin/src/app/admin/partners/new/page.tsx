...
import { ArrowLeft, Save, AlertCircle, Plus, X, Upload, Image as ImageIcon } from 'lucide-react';
...
export default function NewPartnerPage() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-6">Новый партнёр</h1>
